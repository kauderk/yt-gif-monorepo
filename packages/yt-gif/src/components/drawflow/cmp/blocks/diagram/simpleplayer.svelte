...
<body>
	...
	<script>
		...
		let track_art = document.querySelector('.player')
...
<style>
	body {
		background-color: rgba(5, 8, 59, 0.749);
...
align items in a vertical direction */
	.player {
		...
		background-image: URL('https://upload.wikimedia.org/wikipedia/en/d/d4/MeddleCover.jpeg');
