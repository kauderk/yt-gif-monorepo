			...
			<div id="content">
				<div id="featured-slider" data-active-index="0">
						...
						<a
							...
							<div class="featured-slider-item-info-wrapper">
								<div class="featured-slider-item-info">
									...
									<h3 class="price highlight">$59.99</h3>
								</div>
							</div>
						</a>
					</div>
					<div class="featured-slider-navigator">
						<button
							class="featured-slider-navigator-bar"
							type="button"
							data-index="0" />
						<button
							class="featured-slider-navigator-bar"
				...
				<div id="browse">
					<a
						...
						target="_blank">
						<div class="browse-option-background" />
				...
				<div id="list" class="no-scrollbar" data-active-index="0">
					...
					<div class="list-items">
						<a href="#" class="list-item">
							<img
								...
								src="https://images.unsplash.com/photo-1564349683136-77e08dba1ef7?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8cGFuZGF8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" />
							<div class="list-item-info">
								<div class="title-wrapper section">
									<span class="title">Stray Panda</span>
								</div>
...
<style lang="scss">
	...
	* {
	...
	#featured-slider[data-active-index='0']
		> .featured-slider-navigator
		> .featured-slider-navigator-bar[data-index='0'] {
	...
	#featured-slider
		...
		> .featured-slider-item-info-wrapper {
		height: 100%;
		width: 100%;
		background: linear-gradient(
			to top,
			rgb(var(--theme-background)) 10%,
			rgba(var(--theme-background), 0.2) 30%
		);
		display: flex;
	...
	#featured-slider
		> .featured-slider-items
		> .featured-slider-item:nth-child(1) {
		background-image: url('https://images.unsplash.com/photo-1635205411883-ae35d1169f60?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTUxfHx2aWRlbyUyMGdhbWV8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60');
	}
	...
	#featured-slider
		> .featured-slider-navigator
		> .featured-slider-navigator-bar:hover,
	#featured-slider
		> .featured-slider-navigator
		> .featured-slider-navigator-bar:focus {
	...
	#list[data-active-index='0']
		> .list-options
		> .list-option[data-index='0'] {
